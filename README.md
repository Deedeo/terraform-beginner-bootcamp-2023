...
We used CHATGPT to genrate a bashscript to set an alias tf for terraform in both terminals. [bin/set_tf_alias](bin/set_tf_alias).

This `alias tf=terraform` was addes tp the bash profile.